...
- **Нити.** Коснитесь кончиками одинаковых пальцев двух рук — между ними натянется белая нить, она тянется при
  разведении рук и рвётся, если согнуть палец. Между соседними нитями — заливка от цвета левой руки к цвету правой
  (цвета и прозрачность настраиваются).
